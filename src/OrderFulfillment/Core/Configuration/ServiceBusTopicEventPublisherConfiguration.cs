...
namespace OrderFulfillment.Core.Configuration
{
    ...
    /// </summary>
    /// 
    /// <typeparam name="T">The type of event the configuration applies to.</typeparam>
    /// 
    public class ServiceBusTopicEventPublisherConfiguration<T> : IConfiguration
    {
        /// <summary>
        ///   The connection string to the service bus namespace of the event
        ///   topic.
        /// </summary>
        /// 
        ...
        /// <summary>
        ///   The name of the eevnt topic to use for publishing.
        /// </summary>
        /// 
        public string TopicName { get;  set; }

        /// <summary>
        ///   The maximum number of attempts to retry sending an event to the bus.
        /// </summary>
        /// 
        ...
        {
            var sourceAssembly = typeof(ServiceBusTopicEventPublisherConfiguration<T>).Assembly;
