...
{
    /// <summary>
    ///   The set of configuration for the Ecommerce client.
    /// </summary>
    /// 
    public class EcommerceClientConfiguration : IConfiguration
    {
        /// <summary>
        ...
        /// <summary>
        ///   The URL template for the eCommerce GetOrder endpoint.
        /// </summary>
        /// 
        public string GetOrderUrlTemplate { get;  set; }
