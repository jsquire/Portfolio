...
namespace OrderFulfillment.OrderProcessor
{
    /// <summary>
    ...
    public class EntryPoint
    {
        ...
        public static void Main()
        {
            ...
            var orderProcessorConfiguration = container.Resolve<OrderProcessorJobHostConfiguration>();            
            ...
            var hostConfiguration = new JobHostConfiguration
            {
               ...
               DashboardConnectionString = orderProcessorConfiguration.DashboardConnectionString,
               StorageConnectionString   = orderProcessorConfiguration.StorageConnectionString,
               JobActivator              = new AutoFacWebJobActivator(container)
            };

            var serviceBusConfig = new ServiceBusConfiguration
            {
               ConnectionString = orderProcessorConfiguration.ServiceBusConnectionString,
        ...
        {            
            var orderProcessorAssembly = typeof(EntryPoint).Assembly;
            ...
            builder
                .RegisterAssemblyTypes(orderProcessorAssembly, coreAssembly)
            ...
            builder
                .RegisterAssemblyTypes(orderProcessorAssembly, coreAssembly)
                .AssignableTo<ISkuMetadataProcessor>()
                .AsImplementedInterfaces()
                .SingleInstance();

            builder
                .RegisterAssemblyTypes(orderProcessorAssembly, coreAssembly)
                .AssignableTo<IOrderProcessor>()
                .AsImplementedInterfaces()
                .SingleInstance();
            ...
            builder
                ...
                .AsSelf()
                .OnActivating(args => args.ReplaceInstance(args.Context.Resolve<OrderProcessorJobHostConfiguration>().CreateCommandRetryThresholdsFromConfiguration()));
