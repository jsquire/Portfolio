...
namespace OrderFulfillment.OrderProcessor.Tests
{
    /// <summary>
    ...
    public class EntryPointTests
    {
        ...
        public void DependencyResolverDiscoversWebJobFunctions()
        {
            ...
            {
                var orderProcessorFunctions = scope.Resolve<OrderProcessorFunctions>();
                orderProcessorFunctions.Should().NotBeNull("because the Order Processor WebJob functions should be resolvable");
            }
        }
