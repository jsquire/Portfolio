...
using OrderFulfillment.OrderSubmitter.Configuration;
...
namespace OrderFulfillment.OrderSubmitter
{
    /// <summary>
    ...
    public class EntryPoint
    {
        ...
        public static void Main()
        {
            ...
            var orderSubmitterConfiguration = container.Resolve<OrderSubmitterJobHostConfiguration>();            
            ...
            var hostConfiguration = new JobHostConfiguration
            {
               ...
               DashboardConnectionString = orderSubmitterConfiguration.DashboardConnectionString,
               StorageConnectionString   = orderSubmitterConfiguration.StorageConnectionString,
               JobActivator              = new AutoFacWebJobActivator(container)
            };

            var serviceBusConfig = new ServiceBusConfiguration
            {
               ConnectionString = orderSubmitterConfiguration.ServiceBusConnectionString,
