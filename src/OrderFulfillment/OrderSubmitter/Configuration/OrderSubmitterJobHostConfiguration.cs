...
namespace OrderFulfillment.OrderSubmitter.Configuration
{
    /// <summary>
    ///   The configuration needed for the Order Submitter WebJob Host.
    /// </summary>
    /// 
    public class OrderSubmitterJobHostConfiguration : IConfiguration
    {
        /// <summary>
